    ...
    <div className="home-wrapper">
      <div className="container main">
        <div className="content">
          ...
          <p>
            Use this plugin to find out how judges talk about a piece of
          ...
          <p>
            ...
            Chrome Extension inserts a button that, when clicked, will give you
            cases that refer to that section, and tell you how many times it is
            mentioned in each case.
          </p>
          <p>
            It queries our database of 30,000 cases from 2004 onwards - and
            queries the data generated by our legislation algorithm.
          </p>
          <p>
          ...
          <p>
            If you build something with our platform, get in touch and
            we&apos;ll list it here.
          </p>
        </div>
      </div>
