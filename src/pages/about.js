  ...
  return (
    <Layout>
      ...
      <AboutPageContent
        ...
        directors={aboutJson.directors}
        contributors={aboutJson.contributors}
      />
    </Layout>
  )
}

export const AboutPageContent = ({ content, directors, contributors }) => (
  <div className="side-wrapper">
    <div className="container main">
      <div className="content">
        {content.map(({ title, content_html }, idx) => {
          return (
        ...
        <div className="cards-list">
          {contributors.map(({ image_url, title }, idx) => {
            return (
