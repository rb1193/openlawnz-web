...
import Chanil from "../images/about-us/chanil-park.png"
import Benedict from "../images/about-us/benedict-stewart.png"
import Daryl from "../images/about-us/daryl-diesto.png"
    ...
    <div className="home-wrapper">
      <div className="container main">
        <div className="content">
          <h2>What we do</h2>
          <p>
            OpenLaw NZ is an open-source legal data platform. Our goal is to
            improve the accessibility of case law and other legal information in
            New Zealand. We want to make it easier for all New Zealanders to
            understand law.
          </p>
          <p>
            You can use our search to find case law, and navigate between
            related information. You can also use our plugins (or write your
            own) to aid your research.
          </p>
          <p>
            You can use our API to build case law intelligence into your own
            applications and services. For an example, see our{" "}
            <Link to="/plugins">chrome extension</Link>.
          </p>
          <h2>Our data</h2>
          <div className="paragraph-with-figure">
            The data we have currently comprises High Court, Court of Appeal and
            Supreme Court decisions from present day back to approximately 2004
            (with some exceptions, for example some suppressed decisions and
            other judgments that have not been published).
            <br />
            <br />
            We developed software that extracts data from cases. We extract
            structured data, including references to other cases in our
            database, and to any Acts of Parliament (current or repealed). We
            use that software to power our search and API.{" "}
          ...
          <h2>Who we are</h2>
          <p>
            OpenLaw NZ is a registered charity. We’re operated by a fantastic
            group of volunteers, helping with code, design, orchestration, data
            parsing, machine learning and devops.
          </p>
          <p>
            Our volunteers receive real-world experience in react, node.js,
            python and a range of other technologies. If you’d like to get
          ...
          <div className="cards-list">
            <div className="card-item">
              ...
              <p>
                ...
                litigation and family law since 2009. He has been a Member of
                the Auckland District Law Society Technology &amp; Law Committee
                since 2012, and is experienced in web and software development.
                Andrew went to university at Victoria, Wellington, and now lives
                in Whangarei.
              </p>
            </div>
            <div className="card-item">
              ...
              <p>
                ...
                advertising and small businesses including 8 years working with
                open data in projects and hackathons. He has run community
                coding classes and is passionate about empowering disadvantaged
                people with technology. William went to university at Victoria,
                Wellington, and now lives in Sydney.
              </p>
            </div>
          </div>
          ...
          <div className="cards-list">
            <div className="card-item-small">
              ...
              <p>
                April is a visual designer who believes in enhancing experiences
                and making impacts through design.
              </p>
            </div>
            <div className="card-item-small">
              <div>
