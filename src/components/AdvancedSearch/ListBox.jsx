...
const ListBox = ({
  ...
  const automaticSelection = () => {
    ...
    if (resultOnFocus && results[resultOnFocus])
      handleSelection(results[resultOnFocus])
    ...
    <React.Fragment>
      ...
      <div className="comboBox-wrapper">
        ...
        >
          <input
            ...
            aria-activedescendant={
              resultOnFocus != null ? `${id}-result-item-${resultOnFocus}` : ""
            }
          />
          {isInputFocused && !results.length && (
            <div className="listBox">
              <div
                className="listBox__item listBox__item--clean"
                aria-hidden="true"
              >
        ...
        <ul
          ...
          id={`${id}-listbox`}
          className={`listBox ${
            !isInputFocused || (isInputFocused && !results.length)
              ? "hidden"
              : ""
          }`}
        >
          {results.map((result, idx) => (
            ...
            >
              <button
                ...
                className={`a11y-button--unstyled listBox__item ${
                  resultOnFocus === idx ? "listBox__item-focused" : ""
                }`}
              >
